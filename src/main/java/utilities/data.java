...
public class data {
    ...
    public final static String GECKO_DRIVER_DIRECTORY = System.getProperty("webdriver.gecko.driver", "C:/driverManager/geckodriver.exe");
    public final static String CHROME_DRIVER_DIRECTORY = System.getProperty("user.dir") + "\\driver\\chromedriver,exe";
    public final static String HalfCHROME_DRIVER_DIRECTORY = System.setProperty("webdriver.chrome.driver", "C:\\driverManager\\chromedriver.exe");
    ...
    public static final String DRIVERS_DIRECTORY = "//driverManager//";
    public static final String LOCAL_DRIVERS_CHROME_DIRECTORY = "C:\\driverManager\\chromedriver.exe";
    public static final String LOCAL_DRIVERS_FIREFOX_DIRECTORY = "C:\\driverManager\\geckodriver.exe";
    public static final String LOCAL_DRIVERS_IE_DIRECTORY = "C:\\driverManager\\IEDriverServer.exe";
    ...
    public static final String email = "yourEmail@yourEmail.com";
